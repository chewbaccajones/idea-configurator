 ...
 */
public class JarModule extends BaseModuleDeploy
{
    ...
    private String archivePath()
    {
        ...
        String jarName = getName() + ".jar";
        return new ArchivePath().jarPath(path, linkViaManifest, jarName);
    }
    ...
    {
        validate();
        component.jarModuleOutput(getName(), archivePath(), linkViaManifest);
    }
}
