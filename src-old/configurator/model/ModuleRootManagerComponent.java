...
/**
 * ModuleRootManager never has any contents. It appears to be replaced by
 * NewModuleRootManager,  so it's just a tiny dumb class.
 *
 * @author Justin Tomich
 */
public class ModuleRootManagerComponent implements Component
{
