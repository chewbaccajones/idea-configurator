 ...
 */
public abstract class BaseOutput implements XmlElement
{
    protected Url url;
...
//        Element output = dom.createElement(name);
//        parent.appendChild(output);

        Element output = new ElementCreator(name, parent).create();
        url.setAttribute(output);
    }
